...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "CsvObservationProvider": ("core.reflectometry.providers", "CsvObservationProvider"),
    ...
    "JsonObservationProvider": ("core.reflectometry.providers", "JsonObservationProvider"),
    ...
    "MockObservationProvider": ("core.reflectometry.providers", "MockObservationProvider"),
    ...
    "ParquetObservationProvider": ("core.reflectometry.providers", "ParquetObservationProvider"),
