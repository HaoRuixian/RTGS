    ...
    def _build_dynamic_sea_level_products(self, products: list[ProductResult]) -> list[ProductResult]:
        ...
        for reference_product in sea_level_products:
            ...
            metadata = {
                ...
                "dynamic_design_matrix": "1, roc_plus_dt, roc_times_dt_plus_dt_squared",
                ...
                "dynamic_condition_number_before": estimate.condition_number_before,
                "dynamic_condition_number_after": estimate.condition_number_after,
    ...
    def _estimate_dynamic_sea_level_window(
        ...
        *,
        ...
        for item in window_items:
            ...
            design_rows.append(_second_order_dynamic_design_row(roc_like_seconds, delta_t_seconds))
        ...
        return DynamicSeaLevelEstimate(
            ...
            condition_number_before=fit.condition_number_before,
            condition_number_after=fit.condition_number_after,
        )
...
def _second_order_dynamic_design_row(roc_like_seconds: float, delta_t_seconds: float) -> list[float]:
    return [
        1.0,
